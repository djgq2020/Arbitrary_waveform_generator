...
HD_PWD='C:/Users/fan/Desktop/summer_school/wave/wave.runs/Triangle_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Triangle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Triangle.tcl
